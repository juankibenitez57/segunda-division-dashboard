...
const OI_FORMATIONS = {
  /* Horizontal layout: x = depth left(GK)→right(attack), y = vertical position top→bottom */
  '433': [
    { id:'gk',  label:'PO', zones:['GK'],              x:8,  y:50 },
    { id:'li',  label:'LI', zones:['LI','LAT'],        x:22, y:15 },
    { id:'cti', label:'CT', zones:['CTI','CT'],        x:22, y:38 },
    { id:'ctd', label:'CT', zones:['CTD','CT'],        x:22, y:62 },
    { id:'ld',  label:'LD', zones:['LD','LAT'],        x:22, y:85 },
    { id:'mc1', label:'MC', zones:['MC','CC'],          x:46, y:27 },
    { id:'mc2', label:'MC', zones:['MC','CC'],          x:46, y:50 },
    { id:'mc3', label:'MC', zones:['MC','CC'],          x:46, y:73 },
    { id:'ei',  label:'EI', zones:['EI','EXT','MP'],    x:72, y:17 },
    { id:'dc',  label:'DC', zones:['DC'],               x:79, y:50 },
    { id:'ed',  label:'ED', zones:['ED','EXT','MP'],    x:72, y:83 },
  ],
  '4231': [
    { id:'gk',  label:'PO',  zones:['GK'],              x:8,  y:50 },
    { id:'li',  label:'LI',  zones:['LI','LAT'],        x:22, y:15 },
    ...
    { id:'ctd', label:'CT',  zones:['CTD','CT'],        x:22, y:62 },
    { id:'ld',  label:'LD',  zones:['LD','LAT'],        x:22, y:85 },
    { id:'mc1', label:'MC',  zones:['MC'],               x:42, y:38 },
    { id:'mc2', label:'MC',  zones:['MC'],               x:42, y:62 },
    { id:'ei',  label:'EI',  zones:['EI','EXT','MP'],   x:65, y:17 },
    { id:'mp',  label:'MP',  zones:['MP','CC'],          x:65, y:50 },
    { id:'ed',  label:'ED',  zones:['ED','EXT','MP'],   x:65, y:83 },
    { id:'dc',  label:'DC',  zones:['DC'],               x:86, y:50 },
  ],
  '442': [
    { id:'gk',  label:'PO', zones:['GK'],               x:8,  y:50 },
    { id:'li',  label:'LI', zones:['LI','LAT'],         x:22, y:15 },
    ...
    { id:'ctd', label:'CT', zones:['CTD','CT'],         x:22, y:62 },
    { id:'ld',  label:'LD', zones:['LD','LAT'],         x:22, y:85 },
    { id:'ei',  label:'EI', zones:['EI','LAT'],         x:48, y:15 },
    { id:'mc1', label:'MC', zones:['MC','CC'],           x:48, y:38 },
    { id:'mc2', label:'MC', zones:['MC','CC'],           x:48, y:62 },
    { id:'ed',  label:'ED', zones:['ED','LAT'],         x:48, y:85 },
    { id:'dc1', label:'DC', zones:['DC','MP'],           x:80, y:37 },
    { id:'dc2', label:'DC', zones:['DC','MP'],           x:80, y:63 },
  ],
  '352': [
    { id:'gk',  label:'PO',  zones:['GK'],               x:8,  y:50 },
    { id:'cti', label:'CT',  zones:['CTI','CT'],         x:22, y:27 },
    { id:'ct',  label:'CT',  zones:['CT','CTI','CTD'],   x:22, y:50 },
    { id:'ctd', label:'CT',  zones:['CTD','CT'],         x:22, y:73 },
    { id:'car1',label:'CAR', zones:['LI','EI','LAT'],    x:42, y:12 },
    { id:'mc1', label:'MC',  zones:['MC','CC'],           x:42, y:35 },
    { id:'mc2', label:'MC',  zones:['MC','CC'],           x:42, y:50 },
    { id:'mc3', label:'MC',  zones:['MC','CC'],           x:42, y:65 },
    { id:'car2',label:'CAR', zones:['LD','ED','LAT'],    x:42, y:88 },
    { id:'dc1', label:'DC',  zones:['DC','MP'],           x:79, y:38 },
    { id:'dc2', label:'DC',  zones:['DC','MP'],           x:79, y:62 },
  ],
  '4141': [
    { id:'gk',  label:'PO', zones:['GK'],               x:8,  y:50 },
    { id:'li',  label:'LI', zones:['LI','LAT'],         x:22, y:15 },
    ...
    { id:'ctd', label:'CT', zones:['CTD','CT'],         x:22, y:62 },
    { id:'ld',  label:'LD', zones:['LD','LAT'],         x:22, y:85 },
    { id:'mc',  label:'MC', zones:['MC'],               x:38, y:50 },
    { id:'ei',  label:'EI', zones:['EI','EXT'],         x:58, y:15 },
    { id:'cc1', label:'CC', zones:['CC','MC'],           x:58, y:38 },
    { id:'cc2', label:'CC', zones:['CC','MC'],           x:58, y:62 },
    { id:'ed',  label:'ED', zones:['ED','EXT'],         x:58, y:85 },
    { id:'dc',  label:'DC', zones:['DC','MP'],           x:82, y:50 },
  ],
};
